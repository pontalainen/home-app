                    ...
                    <div v-else>
                        <div v-for="(u, index) in users" :key="index"
                            ...
                            <div class="user-buttons flex items-center">
                                <v-btn density="compact" variant="text" size="regular" class="user-button"
                                    :loading="userLoading[u.id]" @mouseover="userHover[u.id] = true"
                                    @mouseleave="userHover[u.id] = false" @click="toggleUser(u)">
                                ...
                                <v-menu location="top">
                                    ...
                                    <v-list width="150">
                                        <v-list-item v-for="(option, index) in userOptions" :key="index">
